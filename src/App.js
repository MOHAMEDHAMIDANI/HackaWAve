...
function App() {
  const [needsLogin, setNeedsLogin] = useState(false); // State to track radio selection
  ...
  return (
    <div className="App container w-full h-fit m-auto">
          ...
          <form className="w-full mx-auto mt-5">
            <div className='w-full flex gap-5 justify-between items-center'>
              ...
              <div className="mb-5 w-1/2">
                ...
                <input type="tel" id="tel" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-none focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required placeholder='Enter phone number' />
              </div>
            </div>
            <div className='w-full flex gap-5 justify-between items-center'>
              <div className="mb-5 w-1/2">
            ...
            {needsLogin && (
              <div className='w-full'>
                ...
                <div className='w-full'>
                  <form class="w-1/3">
                    <div class="mb-5">
                      <label for="email_1" class="block mb-2 text-start text-sm font-medium text-gray-900 dark:text-white">E-mail</label>
                      <input type="email" id="email_1" class="bg-gray-50 border outline-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com" required />
                    </div>
                    <div class="mb-5">
                      <label for="password" class="block text-start mb-2 text-sm font-medium text-gray-900 dark:text-white">Your password</label>
                      <input type="password" id="password" class="bg-gray-50 outline-none border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                  </form>
                </div>
              </div>
            ...
            <div className='w-full flex flex-col border-t-2'>
              <div class="my-5">
                <label for="email" class="block mb-2 text-start text-3xl font-bold text-[#1D2DC3] dark:text-white">website link</label>
                <input type="email" id="email" class="bg-gray-50 border-2 text-xl text-[#1D2DC3] border-[#1D2DC3] rounded-lg focus:ring-blue-500 outline-none focus:border-blue-500 block w-full p-2.5 h-14 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your website's link" required />
              </div>
            </div>
      ...
      <footer className='w-full mt-10'>
        <img src={FooterPic} className='w-full'/>
      </footer>
    </div>
  );
}
